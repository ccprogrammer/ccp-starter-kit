...
class ExampleMyColor {
  static const Color colorWhite = Color(0xffffffff);
  static const Color colorBlack = Colors.black;
  static const Color colorLightBrown = Color.fromARGB(255, 53, 53, 53);
  static const Color colorBrown = Color(0xff1D1D1D);
